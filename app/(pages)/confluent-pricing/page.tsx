...
export default function ConfluentMain() {
  ...
  const specialtyOptions = [
    {
      title: "Dedicated",
      description:
        "Single-tenant Kafka clusters with elastic networking and enterprise-grade requirements",
      savings: "90%",
      savingsText: "typical",
      features: [
    ...
    },
    {
      title: "Freight",
      description:
        "Move your existing data models from on-premises Kafka and other data systems",
  ...
  const faqs = [
    {
      ...
      answer:
        "Elastic Confluent Kafka Units (eCKUs) are our compute units that scale automatically based on your throughput needs. They ensure you only pay for what you use while maintaining consistent performance.",
    },
    {
      question: "How is my monthly bill calculated?",
      answer:
        "Your bill is calculated based on the CKUs consumed, data retention, and any additional features like connectors or ksqlDB queries. We provide detailed usage analytics in your dashboard.",
    },
    {
      question: "How can I get Confluent discounts?",
      answer:
        "We offer volume discounts for annual commitments, startup credits for qualified companies, and special pricing for educational institutions. Contact our sales team for custom pricing.",
    },
    {
      question: "What are annual commitments?",
      answer:
        "Annual commitments provide significant discounts in exchange for a 12-month usage commitment. This helps you save costs while ensuring predictable billing.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Serverless, elastic, consumption-based pricing with your
                workloads in mind. No overprovisioning, manage capacity, or pay
                for idle resources on day one. You only pay for what you use,
                when you use it.
              </p>
