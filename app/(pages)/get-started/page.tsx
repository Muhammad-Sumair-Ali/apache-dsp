...
const features = [
  {
    title: "Stream",
    description:
      "Reimagine Apache Kafka, the de facto standard for data streaming, everywhere - on-prem, in every major public cloud and on the edge.",
  },
  {
    title: "Connect",
    description:
      "Easily on-ramp and off-ramp data, converting even your static data into a network of event streams, with a rich connector ecosystem.",
  },
  {
    title: "Process",
    description:
      "Perform stateful and stateless processing, powered by Apache Flink®, the de facto industry standard for stream processing.",
  },
  {
    title: "Govern",
    description:
      "Make data in motion self-service, secure, compliant and trusted with the industry's only data streaming governance suite.",
  },
];
          ...
          <div className="text-white">
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4">
                Ready? New signups receive $400 to spend during their first 30
                days.
              </h2>
              <p className="text-blue-100 leading-relaxed">
                With Confluent&apos;s cloud-native and complete data streaming
                platform, you can take the following to the next level.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4">
                Use your cloud marketplace account to get started with Confluent
                Cloud:
              </h3>
              <div className="flex flex-wrap gap-4">
                {cloudProviders.map((provider, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-3 cursor-pointer hover:bg-white/20 transition-colors"
                  >
                    ...
                    <>
                      ...
                      <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          >
                            Email me about products, services & events from
                            Confluent
                          </label>
                        </div>
                        ...
                        <Button
                          type="submit"
                          className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 font-semibold text-lg rounded-lg"
                        >
                          Start Free
                        </Button>
                      </form>
                  ...
                  {deploymentType === "SELF-MANAGED" && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-8">
                        Download and deploy Confluent Platform in your own
                        environment with full control over your infrastructure.
                      </p>
