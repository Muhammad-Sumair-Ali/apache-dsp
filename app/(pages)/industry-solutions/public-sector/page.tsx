            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight">
                  Drive Mission Success with Data Streaming for...
                  <br />
                  <span className="text-blue-400">New Use Cases</span>
                </h1>
                <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                  IT leaders in the public sector are facing unprecedented
                  pressure to cut operating costs while maximizing return on
                  investment.. Choosing the right strategy and technology for
                  data modernization and interoperability of government systems
                  is essential for striking this careful balance. Learn more in
                  our latest brief, “Achieving Government Efficiency and
              ...
              <div className="flex flex-col items-center sm:flex-row gap-4">
                <Link
                  target="_blank"
                  href={
                    "https://assets.confluent.io/m/687f7e854cf6767/original/20230215-SB-Digital-Efficiently_Modernizing_Government_Data_Environments.pdf?_gl=1*1x238ey*_gcl_au*MjAyNDEyNDI1My4xNzUzNzk4NTU4*_ga*MTYxODE0MDMwNC4xNzUzNzk4NTU5*_ga_D2D3EGKSGD*czE3NTM5MTM3NjYkbzEyJGcxJHQxNzUzOTE3NDIyJGo2MCRsMCRoMA..&_ga=2.57285738.1597049125.1753798559-1618140304.1753798559"
                  }
                >
                  <Button
                    size="lg"
                ...
                <Dialog open={isVideoOpen} onOpenChange={setIsVideoOpen}>
                  <DialogTrigger asChild>
                    <div className="aspect-video relative cursor-pointer group">
                      <Image
                        height={324}
                        width={576}
                        src="https://images.ctfassets.net/8vofjvai1hpv/7jmw6PZCUzlSwGkJAa2ZWm/8b4c86e76b96f5f1e7e015f7df19723b/why_confluent.jpg?w=992&h=558&q=90&fm=webp&bg=transparent"
                  ...
                  <DialogContent className="max-w-4xl w-full p-0 bg-black border-0">
                    <div className="aspect-video">
                      <iframe
                        src="https://youtu.be/mxilzVbUOHM"
